...
class PreferenceStore(context: Context) {
    ...
    companion object {
        ...
        private const val DEFAULT_FILTER_KEYWORDS = "bca,bni,bri,brimo,bsi,mandiri,livin,seabank,jago,dana,gopay,ovo,shopeepay,flip,gaji,transfer,masuk,keluar,pembayaran,briva,top up,debit,kredit,tarik"
